...
export default function BusBooking({ navigation, route }) {
    ...
    const AccptedHandler = (item) => {
        ...
        setDoc(doc(db, "AccptedListBusBooking", item.email), {
        ...
        deleteDoc(doc(db, 'ExtraBusforAdmin', item.email))
    ...
    useEffect(() => {
        getDocs(collection(db, 'ExtraBusforAdmin'))
            .then((docData) => {
                let newData = [];
                docData.forEach((doc) => {
                        ...
                        <View style={styles.item} key={item.key}>
                            <View style={styles.getFlexDirectionContainer}>
                                <View style={styles.itemsNameContainer}>
                                    <Text style={styles.TextColorChg}>Routes : {item.Routess}</Text>
