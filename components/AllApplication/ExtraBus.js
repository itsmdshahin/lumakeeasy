...
export default function GalleryBooking({ navigation, route }) {
    ...
    const SubmitBooking = () => {
        ...
        if (Routess === "" || BookingDate === "" || BookingTime === "" || email === "" || Reasons === "") {
            Alert.alert("Please Try again somthing is missing!");
        }
        else {
            setDoc(doc(db, "ExtraBus", useremail), {
                Routess: Routess,
        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.viewCon}>
                    <Text style={styles.textCon}>Routes Number</Text>
                    <View style={styles.innerviewCon}>
                        <TextInput style={styles.textInput}
                            ...
                            value={Routess}
                            onChangeText={(Routess) => setRoutess(Routess)}
                        />
                    </View>
                </View>
                ...
                <View style={styles.viewCon}>
                    <Text style={styles.textCon}>Booking Time</Text>
                    <View style={styles.innerviewCon}>
                        <TextInput style={styles.textInput}
                            ...
                            keyboardType='email-address'
                            value={BookingTime}
                            onChangeText={(BookingTime) => setBookingTime(BookingTime)}
                        />
                    </View>
                </View>
