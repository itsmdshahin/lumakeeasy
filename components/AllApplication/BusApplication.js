...
export default function BusApplication({ route, navigation }) {
        ...
        <ScrollView>
            <View style={styles.container} >
                <Text style={styles.textCon}>
                    ...
                    For {item.Reasons} we need extra Vehicals for Route {item.Routess} at {item.BookingTime} on {item.BookingDate}.{'\n'}{'\n'}
                ...
                <View style={styles.detialsForProfile}>
                    <Text style={styles.TextColorChg}>Name : {UserInfo.name}</Text>
                    <Text style={styles.TextColorChg}>ID : {UserInfo.id}</Text>
